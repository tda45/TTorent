...
LangString inst_qbt_req ${LANG_FRENCH} "TTorent (requis)"
...
LangString inst_startup ${LANG_FRENCH} "Démarrer TTorent au démarrage de Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_FRENCH} "Ouvrir les fichiers .torrent avec TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_FRENCH} "Ouvrir les liens magnet avec TTorent"
...
LangString inst_warning ${LANG_FRENCH} "TTorent est en cours d'exécution. Veuillez fermer l'application avant l'installation."
...
LangString launch_qbt ${LANG_FRENCH} "Lancer TTorent."
...
LangString inst_uninstall_link_description ${LANG_FRENCH} "Désinstaller TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_FRENCH} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_FRENCH} "TTorent est en cours d'exécution. Fermez l'application avant de la désinstaller."
