...
LangString inst_qbt_req ${LANG_DANISH} "TTorent (påkrævet)"
...
LangString inst_startup ${LANG_DANISH} "Start TTorent når Windows starter"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_DANISH} "Åbn .torrent-filer med TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_DANISH} "Åbn magnet-links med TTorent"
...
LangString inst_warning ${LANG_DANISH} "TTorent kører. Luk venligst programmet inden installation."
...
LangString launch_qbt ${LANG_DANISH} "Start TTorent."
...
LangString inst_uninstall_link_description ${LANG_DANISH} "Afinstaller TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_DANISH} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_DANISH} "TTorent kører. Luk venligst programmet inden afinstallation."
