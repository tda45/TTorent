...
LangString inst_qbt_req ${LANG_CROATIAN} "TTorent (neophodno)"
...
LangString inst_startup ${LANG_CROATIAN} "Pokrenite TTorent u sustavu Windows start up"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_CROATIAN} "Otvori .torrent datoteke s TTorentom"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_CROATIAN} "Otvori magnet linkove s TTorentom"
...
LangString inst_warning ${LANG_CROATIAN} "TTorent je pokrenut. Zatvorite ga prije instalacije."
...
LangString launch_qbt ${LANG_CROATIAN} "Pokreni TTorent."
...
LangString inst_uninstall_link_description ${LANG_CROATIAN} "Uninstall TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_CROATIAN} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_CROATIAN} "TTorent je pokrenut. Zatvorite ga prije deinstalacije."
