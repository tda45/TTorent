...
LangString inst_qbt_req ${LANG_ITALIAN} "TTorent (necessario)"
...
LangString inst_startup ${LANG_ITALIAN} "Esegui TTorent all'avvio di Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_ITALIAN} "Apri file .torrent con TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_ITALIAN} "Apri collegamenti magnet con TTorent"
...
LangString inst_warning ${LANG_ITALIAN} "TTorent è in esecuzione.$\r$\nChiudilo prima di procedere con l'installazione."
...
LangString launch_qbt ${LANG_ITALIAN} "Esegui TTorent."
...
LangString inst_uninstall_link_description ${LANG_ITALIAN} "Disinstalla TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_ITALIAN} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_ITALIAN} "TTorent è in esecuzione.$\r$\nChiudilo prima di procedere con la disinstallazione."
