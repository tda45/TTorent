...
LangString inst_qbt_req ${LANG_CATALAN} "TTorent (requerit)"
...
LangString inst_startup ${LANG_CATALAN} "Inicia TTorent en iniciar Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_CATALAN} "Obre els fitxers .torrent amb TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_CATALAN} "Obre els enllaços magnètics amb TTorent"
...
LangString inst_warning ${LANG_CATALAN} "TTorent s'està executant. Tanqueu l'aplicació abans d'instal·lar."
...
LangString launch_qbt ${LANG_CATALAN} "Executa TTorent."
...
LangString inst_uninstall_link_description ${LANG_CATALAN} "Desinstal·lar TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_CATALAN} "Aquesta versió ARM64 de TTorent no pot funcionar en sistemes x64. Siusplau, descarrega l'instal·lador x64."
...
LangString uninst_warning ${LANG_CATALAN} "TTorent s'està executant. Tanca l'aplicació abans de desinstal·lar-la."
