...
LangString inst_qbt_req ${LANG_IRISH} "TTorent (required)"
...
LangString inst_startup ${LANG_IRISH} "Start TTorent on Windows start up"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_IRISH} "Open .torrent files with TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_IRISH} "Open magnet links with TTorent"
...
LangString inst_warning ${LANG_IRISH} "TTorent is running. Please close the application before installing."
...
LangString launch_qbt ${LANG_IRISH} "Launch TTorent."
...
LangString inst_uninstall_link_description ${LANG_IRISH} "Uninstall TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_IRISH} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_IRISH} "TTorent is running. Please close the application before uninstalling."
