...
LangString inst_qbt_req ${LANG_GREEK} "TTorent (απαιτείται)"
...
LangString inst_startup ${LANG_GREEK} "Ξεκινήστε το TTorent στα Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_GREEK} "Άνοιγμα των αρχείων .torrent με το TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_GREEK} "Άνοιγμα των μαγνητικών συνδέσμων με το TTorent"
...
LangString inst_warning ${LANG_GREEK} "Το TTorent βρίσκεται σε εκτέλεση. Παρακαλούμε κλείστε την εφαρμογή πριν την εγκατάσταση."
...
LangString launch_qbt ${LANG_GREEK} "Εκκίνηση του TTorent."
...
LangString inst_uninstall_link_description ${LANG_GREEK} "Uninstall TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_GREEK} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_GREEK} "Το TTorent βρίσκεται σε εκτέλεση. Παρακαλούμε κλείστε την εφαρμογή πριν την απεγκατάσταση."
