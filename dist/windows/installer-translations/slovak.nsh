...
LangString inst_qbt_req ${LANG_SLOVAK} "TTorent (požadované)"
...
LangString inst_startup ${LANG_SLOVAK} "Sputiť TTorent pri štarte Windowsu"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_SLOVAK} "Otvárať .torrent súbory v TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_SLOVAK} "Otvárať magnet odkazy v TTorent"
...
LangString inst_warning ${LANG_SLOVAK} "TTorent je spustený. Zatvorte prosím aplikáciu pred inštaláciou."
...
LangString launch_qbt ${LANG_SLOVAK} "Spustiť TTorent."
...
LangString inst_uninstall_link_description ${LANG_SLOVAK} "Odinštalovať TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_SLOVAK} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_SLOVAK} "TTorent je spustený. Zatvorte prosím aplikáciu pred odinštaláciou."
