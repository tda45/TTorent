...
LangString inst_qbt_req ${LANG_DUTCH} "TTorent (vereist)"
...
LangString inst_startup ${LANG_DUTCH} "TTorent starten bij opstarten van Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_DUTCH} "Torrentbestanden openen met TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_DUTCH} "Magneetkoppelingen openen met TTorent"
...
LangString inst_warning ${LANG_DUTCH} "TTorent is actief. Sluit het af voordat u deze update installeert."
...
LangString launch_qbt ${LANG_DUTCH} "TTorent starten."
...
LangString inst_uninstall_link_description ${LANG_DUTCH} "TTorent verwijderen"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_DUTCH} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_DUTCH} "TTorent is actief. Sluit het af voordat u het verwijdert."
