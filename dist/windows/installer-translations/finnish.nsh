...
LangString inst_qbt_req ${LANG_FINNISH} "TTorent (pakollinen)"
...
LangString inst_startup ${LANG_FINNISH} "Käynnistä TTorent Windowsin käynnistyessä"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_FINNISH} "Avaa .torrent tiedostot TTorentilla"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_FINNISH} "Avaa magnet-linkit TTorentilla"
...
LangString inst_warning ${LANG_FINNISH} "TTorent on käynnissä. Sulje ohjelma ennen asennusta."
...
LangString launch_qbt ${LANG_FINNISH} "Käynnistä TTorent."
...
LangString inst_uninstall_link_description ${LANG_FINNISH} "Uninstall TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_FINNISH} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_FINNISH} "TTorent on käynnissä. Sulje ohjelma ennen poistamista."
