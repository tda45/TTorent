...
LangString inst_qbt_req ${LANG_POLISH} "TTorent (wymagany)"
...
LangString inst_startup ${LANG_POLISH} "Uruchamiaj TTorent wraz z systemem Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_POLISH} "Otwieraj pliki .torrent za pomocą TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_POLISH} "Otwieraj odnośniki magnet za pomocą TTorent"
...
LangString inst_warning ${LANG_POLISH} "TTorent jest uruchomiony. Proszę zamknąć aplikację przed instalacją."
...
LangString launch_qbt ${LANG_POLISH} "Uruchom TTorent."
...
LangString inst_uninstall_link_description ${LANG_POLISH} "Odinstaluj TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_POLISH} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_POLISH} "TTorent jest uruchomiony. Zamknij aplikację przed odinstalowaniem."
