...
LangString inst_qbt_req ${LANG_LITHUANIAN} "TTorent (reikalingas)"
...
LangString inst_startup ${LANG_LITHUANIAN} "Pradėti „TTorent“ paleidus „Windows“"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_LITHUANIAN} "Atidaryti .torrent failus su TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_LITHUANIAN} "Atidaryti magneto nuorodas su TTorent"
...
LangString inst_warning ${LANG_LITHUANIAN} "TTorent yra paleistas. Prašome uždaryti programą prieš įdiegiant."
...
LangString launch_qbt ${LANG_LITHUANIAN} "Paleisti TTorent."
...
LangString inst_uninstall_link_description ${LANG_LITHUANIAN} "Pašalinti TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_LITHUANIAN} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_LITHUANIAN} "TTorent yra paleistas. Prašome uždaryti programą prieš išdiegiant."
