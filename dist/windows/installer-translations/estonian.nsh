...
LangString inst_qbt_req ${LANG_ESTONIAN} "TTorent (vajalik)"
...
LangString inst_startup ${LANG_ESTONIAN} "Käivita TTorent Windowsi käivitamisel"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_ESTONIAN} "Ava .torrent failid TTorentiga"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_ESTONIAN} "Ava magnet lingid TTorentiga"
...
LangString inst_warning ${LANG_ESTONIAN} "TTorent töötab. Palun sulge see programm, enne installi."
...
LangString launch_qbt ${LANG_ESTONIAN} "Käivita TTorent."
...
LangString inst_uninstall_link_description ${LANG_ESTONIAN} "Desinstalli TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_ESTONIAN} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_ESTONIAN} "TTorent töötab. Palun sulge programm, enne desinstallimist."
