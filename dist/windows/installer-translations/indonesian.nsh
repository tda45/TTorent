...
LangString inst_qbt_req ${LANG_INDONESIAN} "TTorent (wajib)"
...
LangString inst_startup ${LANG_INDONESIAN} "Jalankan TTorent pada start up Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_INDONESIAN} "Buka file .torrent dengan TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_INDONESIAN} "Buka link magnet dengan TTorent"
...
LangString inst_warning ${LANG_INDONESIAN} "TTorent berjalan. Harap tutup aplikasi sebelum menginstal."
...
LangString launch_qbt ${LANG_INDONESIAN} "Buka TTorent."
...
LangString inst_uninstall_link_description ${LANG_INDONESIAN} "Hapus TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_INDONESIAN} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_INDONESIAN} "TTorent berjalan. Mohon tutup aplikasi sebelum menghapus."
