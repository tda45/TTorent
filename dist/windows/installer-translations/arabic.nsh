...
LangString inst_qbt_req ${LANG_ARABIC} "TTorent (مطلوب)"
...
LangString inst_startup ${LANG_ARABIC} "بدء TTorent على ويندوز بدء التشغيل"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_ARABIC} "فتح ملفات التورنت باستخدام TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_ARABIC} "فتح الروابط المغناطيسية باستخدام TTorent"
...
LangString inst_uninstall_link_description ${LANG_ARABIC} "Uninstall TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_ARABIC} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
