...
LangString inst_qbt_req ${LANG_UZBEK} "TTorent (talab qilinadi)"
...
LangString inst_startup ${LANG_UZBEK} "TTorent Windows bilan birga ishga tushirilsin"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_UZBEK} ".torrent fayllar TTorent bilan ochilsin"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_UZBEK} "Magnit havolalar TTorent bilan ochilsin"
...
LangString inst_warning ${LANG_UZBEK} "TTorent ishga tushgan. Iltimos, oʻrnatishdan oldin dasturni yoping."
...
LangString launch_qbt ${LANG_UZBEK} "TTorent ishga tushirilsin."
...
LangString inst_uninstall_link_description ${LANG_UZBEK} "TTorent oʻchirilsin"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_UZBEK} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_UZBEK} "TTorent ishga tushgan. Iltimos, oʻchirishdan oldin dasturni yoping."
