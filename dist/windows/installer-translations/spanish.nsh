...
LangString inst_qbt_req ${LANG_SPANISH} "TTorent (necesario)"
...
LangString inst_startup ${LANG_SPANISH} "Iniciar TTorent en el inicio de Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_SPANISH} "Abrir archivos .torrent con TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_SPANISH} "Abrir enlaces magnet con TTorent"
...
LangString inst_warning ${LANG_SPANISH} "TTorent se está ejecutando. Ciérrelo antes de continuar."
...
LangString launch_qbt ${LANG_SPANISH} "Iniciar TTorent."
...
LangString inst_uninstall_link_description ${LANG_SPANISH} "Desinstalar TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_SPANISH} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_SPANISH} "TTorent se está ejecutando. Ciérrelo antes de continuar."
