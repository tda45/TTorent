...
LangString inst_qbt_req ${LANG_PORTUGUESEBR} "TTorent (requerido)"
...
LangString inst_startup ${LANG_PORTUGUESEBR} "Iniciar o TTorent na inicialização do Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_PORTUGUESEBR} "Abrir arquivos .torrent com o TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_PORTUGUESEBR} "Abrir links magnet com o TTorent"
...
LangString inst_warning ${LANG_PORTUGUESEBR} "O TTorent está em execução. Por favor feche o aplicativo antes de instalar."
...
LangString launch_qbt ${LANG_PORTUGUESEBR} "Executar o TTorent."
...
LangString inst_uninstall_link_description ${LANG_PORTUGUESEBR} "Desinstalar o TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_PORTUGUESEBR} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_PORTUGUESEBR} "O TTorent está em execução. Por favor feche o aplicativo antes de desinstalar."
