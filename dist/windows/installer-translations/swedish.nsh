...
LangString inst_qbt_req ${LANG_SWEDISH} "TTorent (krävs)"
...
LangString inst_startup ${LANG_SWEDISH} "Starta TTorent vid Windows-uppstart"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_SWEDISH} "Öppna .torrent-filer med TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_SWEDISH} "Öppna magnetlänkar med TTorent"
...
LangString inst_warning ${LANG_SWEDISH} "TTorent körs. Stäng programmet innan du installerar."
...
LangString launch_qbt ${LANG_SWEDISH} "Kör TTorent."
...
LangString inst_uninstall_link_description ${LANG_SWEDISH} "Avinstallera TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_SWEDISH} "Denna ARM64-version av TTorent kan inte köras på x64-system. Hämta x64-installationsprogrammet."
...
LangString uninst_warning ${LANG_SWEDISH} "TTorent körs. Stäng programmet innan du avinstallerar."
