...
LangString inst_qbt_req ${LANG_HEBREW} "TTorent (נדרש)"
...
LangString inst_startup ${LANG_HEBREW} "התחל את TTorent עם עליית Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_HEBREW} "פתח קבצי .torrent עם TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_HEBREW} "פתח קישורי מגנט עם TTorent"
...
LangString inst_warning ${LANG_HEBREW} "TTorent פועל. אנא סגור את האפליקציה לפני ההתקנה."
...
LangString launch_qbt ${LANG_HEBREW} "הפעל את TTorent."
...
LangString inst_uninstall_link_description ${LANG_HEBREW} "הסר את ההתקנה של TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_HEBREW} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_HEBREW} "TTorent is running. Please close the application before uninstalling."
