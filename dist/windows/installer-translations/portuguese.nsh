...
LangString inst_qbt_req ${LANG_PORTUGUESE} "TTorent (obrigatório)"
...
LangString inst_startup ${LANG_PORTUGUESE} "Iniciar o TTorent no arranque do Windows"
;LangString inst_torrent ${LANG_ENGLISH} "Open .torrent files with TTorent"
LangString inst_torrent ${LANG_PORTUGUESE} "Abrir ficheiros .torrent com o TTorent"
;LangString inst_magnet ${LANG_ENGLISH} "Open magnet links with TTorent"
LangString inst_magnet ${LANG_PORTUGUESE} "Abrir ligações magnet com o TTorent"
...
LangString inst_warning ${LANG_PORTUGUESE} "O TTorent está a ser executado. Por favor, feche a aplicação antes de instalar esta versão."
...
LangString launch_qbt ${LANG_PORTUGUESE} "Iniciar TTorent."
...
LangString inst_uninstall_link_description ${LANG_PORTUGUESE} "Desinstalar TTorent"
...
LangString inst_arch_mismatch_arm64_on_x64 ${LANG_PORTUGUESE} "This ARM64 version of TTorent cannot run on x64 systems. Please download the x64 installer."
...
LangString uninst_warning ${LANG_PORTUGUESE} "O TTorent está a ser executado. Por favor, feche a aplicação antes de desinstalar esta versão."
